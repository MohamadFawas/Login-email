...
public class QVerificationToken extends EntityPathBase<VerificationToken> {
    ...
    private static final long serialVersionUID = -106070022L;
    ...
    public final com.defect.tracker.user.QUser user;
    ...
    public QVerificationToken(Class<? extends VerificationToken> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.defect.tracker.user.QUser(forProperty("user")) : null;
    }
